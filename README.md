...
### sdf and urdf
All sdf and urdf files were written using online documentation, sdformat.org was the main resource used for the sdf files ( [sdformat-website](https://sdformat.org/spec/1.11/sdf/)). Official ROS2 docs were used to create the urdf files ([ros2-urdf-docs](https://docs.ros.org/en/humble/Tutorials/Intermediate/URDF/URDF-Main.html)).